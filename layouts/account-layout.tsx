                    ...
                    <ul className="sticky top-20 space-y-1 px-4">
                        {
                            items.map((item) => (
                                <li>
                                    <Link href={"/account" + item.route}>
                                        <button className={router.pathname == "/account" + item.route ? styles.active_button : styles.sidebar_button}>
                                            {item.name}
                                        </button>
                                    </Link>
                                </li>
...
const logoutButton = "text-blue-600 font-medium px-6 py-2 w-full text-start rounded-md ease-in duration-150 hover:text-blue-800 hover:bg-blue-100"